...
namespace KingdomRushTowers
{
    ...
    {
        public class ArcherTower : ModTower<KingdomRushTowerSet>
        {
        ...
        public class MusketeerGarrison : ModUpgrade<ArcherTower>
        {
            ...
            public override void ApplyUpgrade(TowerModel towerModel)
            {
                ...
                attackModel.weapons[0].projectile.display = new PrefabReference() { guidRef = "16b6c4224d027c0458d937e69cdc8b6f" };

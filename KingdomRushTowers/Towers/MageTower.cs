...
namespace KingdomRushTowers
{
    ...
    {
        public class MageTower : ModTower<KingdomRushTowerSet>
        {
        ...
        public class Polymorph : ModUpgrade<MageTower>
        {
            ...
            public override void ApplyUpgrade(TowerModel towerModel)
            {
                ...
                //attackModel.weapons[0].projectile.GetBehavior<SlowModel>().overlay = new Il2CppSystem.Collections.Generic.Dictionary<string, Assets.Scripts.Models.Effects.AssetPathModel>();
                attackModel.weapons[0].projectile.AddBehavior(Game.instance.model.GetTowerFromId("GlueGunner-050").GetAbilities()[0].GetBehavior<ActivateAttackModel>().attacks[0].weapons[0].projectile.GetBehavior<AddBonusDamagePerHitToBloonModel>().Duplicate());

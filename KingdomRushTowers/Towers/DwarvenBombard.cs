...
using KingdomRushTowers.Towers;

namespace KingdomRushTowers
{
    public static class DwarvenBombard_
    {
        public class DwarvenBombard : ModTower<KingdomRushTowerSet>
        {
        ...
        public class Teslax104 : ModUpgrade<DwarvenBombard>
        {
            ...
            public override void ApplyUpgrade(TowerModel towerModel)
            {
                ...
                effect.displayPaths[0] = ModContent.CreatePrefabReference<Lightning1>();
                effect.displayPaths[1] = ModContent.CreatePrefabReference<Lightning2>();
                effect.displayPaths[2] = ModContent.CreatePrefabReference<Lightning3>();
                effect.displayPaths[3] = ModContent.CreatePrefabReference<Lightning4>();
                effect.displayPaths[4] = ModContent.CreatePrefabReference<Lightning5>();
                effect.displayPaths[5] = ModContent.CreatePrefabReference<Lightning6>();
                effect.displayPaths[6] = ModContent.CreatePrefabReference<Lightning7>();
                effect.displayPaths[7] = ModContent.CreatePrefabReference<Lightning8>();
                effect.displayPaths[8] = ModContent.CreatePrefabReference<Lightning9>();
            }
            public override string Icon => "UpgradeIconKR";
        ...
        {
            public override string DisplayName => "Supercharged Bolt";

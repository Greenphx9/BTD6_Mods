...
public static class ModHelperData
{
    ...
    public const string Name = "Infinite Ultraboost";

    public const string Description = "Allows you to ultraboost more than 20 times.";
    ...
    public const string SubPath = "InfiniteUltraboost";
    public const string DllName = "InfiniteUltraboost.dll";
}